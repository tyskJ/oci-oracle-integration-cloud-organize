...
=====================================================================
* `詳細 <https://qiita.com/tyskJ/items/4ad08a1b564edb50f626>`_
...
.. note::
  ...
  * 項番6でデプロイしたFunctionsの各OCIDを、 ``oci.auto.tfvars`` 内の ``fn_*_ocid`` に変更し以下コマンドを実行
...
8. 統合作成
---------------------------------------------------------------------
* `Integration <./create_integration.rst>`_
